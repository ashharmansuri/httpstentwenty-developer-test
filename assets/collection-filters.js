class CollectionFilters extends HTMLElement {
    ...
    connectedCallback() {
        this.heading = this.querySelector(".collection-filters__heading");
        ...
        // Price range is optional: collections may not have a price filter
        this.minRange?.addEventListener("input", this.handleRangeInput);
        this.maxRange?.addEventListener("input", this.handleRangeInput);

        // Mobile: tap the "Filters" heading to open/close the panel
        this.heading?.addEventListener("click", this.handleHeadingClick);
    }
    ...
    disconnectedCallback() {
        ...
        this.heading?.removeEventListener("click", this.handleHeadingClick);
    }
    ...
    handleFilterChange(event) {
        ...
        fetch(url.toString())
            ...
            .then((html) => {
                ...
                // Remember which accordions are open
                ...
                // Remember whether the mobile filter panel was open
                if (this.classList.contains("is-open")) {
                    tempDiv
                        .querySelector("collection-filters")
